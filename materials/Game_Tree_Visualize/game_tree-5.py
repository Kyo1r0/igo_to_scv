...
def main():
    CSV_FILE_PATH = 'board_simple.csv' # Canvasで開いているファイルを指定
    MAX_DEPTH = 3
    ...
    # --- ここが修正点 ---
    # 黒先手グラフの開始ノードから白先手グラフの開始ノードへ、
    # 見えないエッジを追加することで、縦方向のレイアウトを強制します。
    dot.edge(start_node_black.id, start_node_white.id, style='invis')
